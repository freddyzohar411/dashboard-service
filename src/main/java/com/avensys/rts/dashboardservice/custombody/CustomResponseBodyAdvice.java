package com.avensys.rts.dashboardservice.custombody;
 ...
 *
 * @author Rahul Sahu
 * @description This class is used to intercept the response body and inject
 *              audit data into the response body.
 *
 */
...
public class CustomResponseBodyAdvice implements ResponseBodyAdvice<Object> {
	...
	public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
		...
		try {
			...
			Long startTime = (Long) ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes())
					.getRequest().getAttribute("startTime");
			String threadId = (String) ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes())
					.getRequest().getAttribute("threadId");
